          ...
          {vipTips.length > 0 && (
            <View className="mb-12 mt-4 items-center rounded-[48px] border border-slate-200 bg-white p-10 shadow-xl">
              <Text className="text-4xl font-black tracking-tighter text-gold-500">
                {vipTips.reduce((acc, curr) => acc * parseFloat(curr.odds || '1'), 1).toFixed(2)}{' '}
                Odds
              </Text>
      ...
      <ScrollView className="flex-1 px-5 pt-4">
        ...
        <View className="mb-10 rounded-[48px] border border-slate-200 bg-white p-10 shadow-2xl">
          ...
          <TouchableOpacity
            ...
            <Text className="text-5xl font-black tracking-tighter text-gold-500">
              {clientUserId}
            </Text>
          ...
          <View className="mt-10">
            <Button
              ...
              onPress={() =>
                Linking.openURL(
                  `whatsapp://send?phone=256${WHATSAPP_NUMBER.slice(1)}&text=I have paid for AlphaWins VIP. ID: ${clientUserId}`
                )
              }
            />
          </View>
