        ...
        <View className="px-5 pt-5">
          ...
          {tips.length === 0 ? (
            <View className="mb-5 items-center rounded-2xl border border-slate-100 bg-white p-8">
              <Text className="text-xs font-medium text-slate-400">No active free tips</Text>
            </View>
          ) : (
            tips.map((item) => (
              <View
          ...
          {/* Add Tip Form */}
          <View className="mt-4 rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
            <Text className="mb-4 text-base font-bold text-navy-950">Add Free Tip</Text>
            ...
            <TextInput
              ...
              placeholder="Tip (e.g. BTTS, Over 2.5, Home Win)"
              placeholderTextColor="#94a3b8"
              value={form.tip}
            ...
            <Button title="PUBLISH TIP" variant="primary" onPress={addTip} />
          </View>
        </View>
      </ScrollView>
